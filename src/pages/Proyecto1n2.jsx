...
const problemasNivel2 = [
  {
    enunciado: (
      <>
        ...
        <p>
          Si x, y, z, w representan el consumo de internet de cada dispositivo, ¿cómo deben repartirse para que el total sea de 200 Mbps?
        </p>
      </>
    ),
    validacion: ({ x, y, z, w }) =>
  ...
  },
  {
    enunciado: (
      <>
        ...
        <p>
          Si x, y, z y w representan el consumo de internet de cada dispositivo, ¿cómo deben repartirse para que el total sea de 180 Mbps?
        </p>
      </>
    ),
    validacion: ({ x, y, z, w }) =>
  ...
  },
  {
    enunciado: (
      <>
        ...
        <p>
          Si x, y, z y w representan el consumo de internet de cada dispositivo, ¿cómo deben repartirse para que el total sea de 220 Mbps?
        </p>
      </>
    ),
    validacion: ({ x, y, z, w }) =>
